    ...
    return (
      <View style={styles.container}>
        ...
        <Swiper
          ...
          autoplay={true}
          autoplayTimeout={3}
          activeDotStyle={{ backgroundColor: COLORS.MAIN_RED_DARK }}
        >
        ...
        <View style={styles.viewUnder}>
          ...
          <Text style={styles.description}>Hi there, this is the demo for Woocommerce written by React-Native</Text>
        </View>
